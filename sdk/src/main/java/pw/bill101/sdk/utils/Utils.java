...
public class Utils {
    ...
    public static void updateUserNameList(String loginUserName) {
        ...
        AppCacheUtils.get(GameFun.getContext()).put(Consts.Cache.USERNAME_LIST, result.toString());
    }
    ...
    public static List<String> getUserNameList() {
        List<String> list = new ArrayList<>();
        String userNameList = AppCacheUtils.get(GameFun.getContext()).getString(Consts.Cache.USERNAME_LIST);
        if (StringUtils.isEmpty(userNameList)) {
        } else {
            String[] userList = userNameList.split(",");
            if (userList == null || userList.length == 0) {
